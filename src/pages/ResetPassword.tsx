...
const navigate = useNavigate()
    ...
    return (<AuthLayout>
        ...
        <div className="w-full
                 max-w-[448px]  bg-background md:bg-white px-12 py-12 rounded-l-lg shadow-card flex flex-col items-center justify-center">
                <div className="w-full">
                <h2 className="text-title-card text-slate-dark">Create a New Password</h2>
                <p className="text-body-sm mt-2 text-slate-mid">Create a new, strong password to secure your workstation
                access.</p>
                </div>
